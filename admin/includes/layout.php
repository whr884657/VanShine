...
function vs_admin_menu_groups()
{
    return array(
        ...
        array(
            ...
            'icon'     => 'cloud',
            'children' => array(
                array('id' => 'cdn_edgeone', 'title' => 'EO 概览', 'url' => '/admin/cdn/edgeone/index.php'),
                array('id' => 'cdn_edgeone_zones', 'title' => '站点管理', 'url' => '/admin/cdn/edgeone/zones.php'),
                array('id' => 'cdn_edgeone_domains', 'title' => '域名加速', 'url' => '/admin/cdn/edgeone/domains.php'),
                array('id' => 'cdn_edgeone_content', 'title' => '内容刷新', 'url' => '/admin/cdn/edgeone/content.php'),
                array('id' => 'cdn_edgeone_security', 'title' => '安全证书', 'url' => '/admin/cdn/edgeone/security.php'),
                array('id' => 'cdn_edgeone_edge', 'title' => '边缘函数', 'url' => '/admin/cdn/edgeone/edge.php'),
                array('id' => 'cdn_edgeone_l4', 'title' => '四层代理', 'url' => '/admin/cdn/edgeone/l4.php'),
                array('id' => 'cdn_edgeone_monitor', 'title' => '监控日志', 'url' => '/admin/cdn/edgeone/monitor.php'),
                array('id' => 'cdn_esa', 'title' => 'ESA', 'url' => '/admin/cdn/esa.php'),
            ),
        ),
        array(
            'id'       => 'archive',
            ...
            'icon'     => 'archive',
            'children' => array(
                array('id' => 'archive_articles', 'title' => '文章', 'url' => '/admin/archive/articles.php'),
