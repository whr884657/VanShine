...
<head>
    ...
    <link rel="stylesheet" href="<?php echo vs_e(vs_base_url()); ?>/assets/css/common.css?v=<?php echo VS_VERSION; ?>">
...
<div class="vs-share-guard__card">
    ...
    <p class="vs-share-guard__lead">您正在访问 <?php echo vs_e($siteName); ?> 的<strong>受保护分享入口</strong>。本页面不对公众开放目录浏览。</p>



    <section class="vs-share-guard__section">

        <h2 class="vs-share-guard__section-title">访问须知</h2>
    ...
    <section class="vs-share-guard__section">
        ...
        <h2 class="vs-share-guard__section-title">法律法规提示</h2>
        ...
        <p class="vs-share-guard__legal-note">违反上述法律法规的行为，可能承担民事赔偿、行政处罚或刑事责任。本站保留向有关主管部门报告及追究法律责任的权利。</p>

    </section>



    <p class="vs-share-guard__foot">若您持有合法分享链接，请使用分享者提供的完整地址访问。如有疑问，请联系内容分享者或站点管理员。</p>
</div>
